...
- Incorrect parsing of DIMACS WCNF files with duplicate soft clauses (#409)
- Update patch updates (#412)
- Update rust crate syn to v2.0.104 (#413)
- Update rust crate minijinja to 2.11.0 (#417)
- Handle null pointers in empty ranges from solvers (#418)

### Documentation

- Reference and architecture diagram (#410)
