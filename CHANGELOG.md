...
- Update patch updates to 0.27.2 ([#524](https://github.com/chrjabs/rustsat/pull/524)) ([6ba1685](6ba16857f929a1133ddbffb7cc7641e54651d3d3)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Update rust crate minijinja to 2.13.0 ([#525](https://github.com/chrjabs/rustsat/pull/525)) ([e564cfb](e564cfb035ab44d1669765233259c9186e3066c5)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Revert update to yanked `flate2` ([#532](https://github.com/chrjabs/rustsat/pull/532)) ([aaed36c](aaed36c4779fb578b48628e41194d7661fcb38b8))
- Proper state handling ([10188ed](10188edfc85f3681f1caf4d8fad371c388b35e52))
- Update rust crate minijinja to 2.14.0 ([#537](https://github.com/chrjabs/rustsat/pull/537)) ([ea50d0b](ea50d0ba71dd98b372c577c06c78fe2721e805e3)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Typos ([422db78](422db78de54f661645ad73fb59d39ffc5b4c323a))
- Don't assert but return `None` ([#548](https://github.com/chrjabs/rustsat/pull/548)) ([27f9eea](27f9eea9d3e942b000c4a1a1ae46a8219f97e002))
...
- 2-product am1 encoding ([#539](https://github.com/chrjabs/rustsat/pull/539)) ([ed5ac2c](ed5ac2cbb3025965681f336f0b36c1df4c7d282e))

### Miscellaneous Tasks

- Update pyo3 to 0.27.1 ([#510](https://github.com/chrjabs/rustsat/pull/510)) ([e36799b](e36799bfa298ad8706e7aaa1b7ae27c399234a5c))
- Remove unused dependencies ([7b0ae6e](7b0ae6ebdb8d0c40a0ce383544880f8c0b08286b))

### Refactor

- Iterate over nodes in `leaf_iter` for `NodeDb` ([7753acd](7753acd28d3ab3a4ca4ba21a31834306fb5fddda))
- Remove recursion in building totalizer trees ([#540](https://github.com/chrjabs/rustsat/pull/540)) ([7be4b8b](7be4b8b939241a262ac36fee22e9eb83c80f738d))
