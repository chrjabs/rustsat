...
- `AddAssign` and `SubAssign` for `Lit` ([db5331f](db5331f4e33e9b3ee154827d1e94e99987bc3ac4))
- Bit operations on `Lit` and `Var` ([0a46d84](0a46d8409d83404e2a1284829e609de06d20a6e9))
- Introduce space in MCNF after `o` ([84b6a68](84b6a685ed636d0eb7eb10d8622deced65dfefe5))
- Support `max:` objectives ([#609](https://github.com/chrjabs/rustsat/pull/609)) ([58a2a1d](58a2a1d4dcb0b25611fe535a1729630a770ce7b6))
- [**breaking**] `Lit::lidx32` and `Lit::from_lidx` instead of bitwise operations ([28a31dc](28a31dc651826ccacf01237fa7dd3fbd86b208a5))
- Operators for generating formulas ([310029b](310029bde60abb5b7beb12a44aff32380cea42b2))
- Evaluate objectives when enumerating ([#630](https://github.com/chrjabs/rustsat/pull/630)) ([4fab2a7](4fab2a772f055e37b0cab727d47bc684e6f44940))
- Impl traits for `std::borrow::Cow<'_, Clause>` ([#694](https://github.com/chrjabs/rustsat/pull/694)) ([f30198f](f30198f0d150670e09a097f36c9484394e6665af))
- Improve objective normalization ([156533b](156533b67f8481bf3055fb8977c8a34d3d465e13))
- Add ability to get output literals ([998d0ed](998d0edd2cc8129404a7e8bd48019d55048c7fd5))

### <!-- 1 -->Bug Fixes

- Update patch updates ([#585](https://github.com/chrjabs/rustsat/pull/585)) ([fb0f508](fb0f508528e71b9dbdd34498006be86bc6c70af2)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Update patch updates to 0.28.1 ([#601](https://github.com/chrjabs/rustsat/pull/601)) ([ea369d0](ea369d084d576b0de0bc0ef3664fbcbf0ffb9dfb)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Update patch updates ([#606](https://github.com/chrjabs/rustsat/pull/606)) ([140802d](140802d5f982460a381b09acff12d9f83f3dab9f)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Update rust crate minijinja to 2.16.0 ([#607](https://github.com/chrjabs/rustsat/pull/607)) ([9556c7b](9556c7b7886d74c79598f1cf562da9321abffb9e)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Update rust crate minijinja to 2.17.1 ([#617](https://github.com/chrjabs/rustsat/pull/617)) ([9e730e3](9e730e3b70591871556d8e8001a13b338f2d09c8)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Update rust crate minijinja to 2.18.0 ([#626](https://github.com/chrjabs/rustsat/pull/626)) ([1aa3a0f](1aa3a0f7192f17481ed5c07facec329bd8c64bca)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Derive serde traits for tests ([d82a574](d82a574ee0e0bf817a104a2ee1d63ef1f65ab7a8))
- Update patch updates ([#641](https://github.com/chrjabs/rustsat/pull/641)) ([437b854](437b854498f872dc2fad43940c34e3381c8e24d0)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Update rust crate minijinja to 2.19.0 ([#642](https://github.com/chrjabs/rustsat/pull/642)) ([6772663](6772663ced5e08e6820115efba78788dc7ed2656)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Update rust crate similar to v3 ([#643](https://github.com/chrjabs/rustsat/pull/643)) ([10b479c](10b479ccd11754297a284be039257f8fd38b5b3f)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Update rust crate similar to 3.1.0 ([#658](https://github.com/chrjabs/rustsat/pull/658)) ([3f2e69d](3f2e69d901e264281564373cd887c4a54a13fca1)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Update rust crate minijinja to 2.20.0 ([#687](https://github.com/chrjabs/rustsat/pull/687)) ([1dc43a5](1dc43a59994b4e692a3b33dc8abf8f9852588657)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- `Objective::unweighted_2_weighted` was dropping duplicate softs ([9b83752](9b837526527b956cae0dfac6857307bdfb0fdf9e))
- Update patch updates ([#700](https://github.com/chrjabs/rustsat/pull/700)) ([1fc634f](1fc634ff824d7ed2839857329719a7c67b601e5e)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
...
- Update rust crate minijinja to 2.21.0 ([#706](https://github.com/chrjabs/rustsat/pull/706)) ([d8e6443](d8e6443eed1d3af72080ca2eee0a30e80a0e199a)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Add `https` feature to `git2` ([#714](https://github.com/chrjabs/rustsat/pull/714)) ([d2c728e](d2c728e75f61470240f731c293700db81c6583ea))
- Update patch updates ([#734](https://github.com/chrjabs/rustsat/pull/734)) ([a74ae24](a74ae24794d884824b43ef630322b33cffa84bcf)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Update rust crate minijinja to 2.23.0 ([#735](https://github.com/chrjabs/rustsat/pull/735)) ([925c20a](925c20a70d8c5dc5b3b1e7e192da8c9c04e3fe81)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Update rust crate minijinja to 2.24.0 ([#740](https://github.com/chrjabs/rustsat/pull/740)) ([acb079e](acb079e4df3e6c19d47e2ba7a3cefaa3c65987fb)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>
- Update rust crate similar to 3.2.0 ([#742](https://github.com/chrjabs/rustsat/pull/742)) ([12df94d](12df94ddc5681d53e20dcf76ab52b35c1bb8c0d8)), Co-authored-by:renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>

### <!-- 2 -->Performance

- [**breaking**] Improve speed of collecting objectives ([c5473fd](c5473fd695e29b19a28e308ed247af1521603478)), fixes #697

### <!-- 4 -->Testing

- Benches for parsers ([f5eb751](f5eb7514b9cf9d578aead921d0e04c368a6d97b3))

### <!-- 5 -->Refactor

- [**breaking**] Rewrite OPB parsers in `winnow` as iterators ([fa0cf65](fa0cf65148e082d7f001b67f75bbd552ea9e3483)), closes #562
- [**breaking**] Rewrite DIMACS parsers in `winnow` as iterators ([6b7a110](6b7a1102fa5c5c10f77c295c1c68732a803ce9e2)), closes #563
- [**breaking**] Custom error types instead of `anyhow` ([e5511a0](e5511a009bf2ac15c9d060ce7f3984e7faf6189f))
- [**breaking**] Parsers and writers take by value ([9b1fac1](9b1fac1e1e30f972c14137b8a9d8d33e8c3d91b7))
- Migrate `rustsat-tools` parsers to `winnow` ([9cd381b](9cd381b5b2feaac9b2f9f7fbdaaf8422468f72e5)), closes #564
- Switch to `mod.rs` for root modules ([257bfb6](257bfb6c2490c1f1347e6cb2521bcca3376f41b4))
- Define conditionally pub modules via macro ([e42a755](e42a7554a850ffc26814b1ff87a3e91d50980bf5))
- Use macro by example in solvertests ([d1994a1](d1994a18a30a836a30406f230d7f3313e98d33c3))
- Clean up unnecessary nesting of code ([75c8da5](75c8da577b6c21646667fb09f3fe7c8ff392e217))
- [**breaking**] Migrate all crates to rust edition 2024 ([#747](https://github.com/chrjabs/rustsat/pull/747)) ([9bf5e42](9bf5e42a3651314e103f5535e37c2b95985833da))

### <!-- 8 -->Miscellaneous Tasks

- Update msrv to 1.87.0 ([c998ffb](c998ffb955dec9b76530b0bb9cc6717b7654fda1))
- Update `pyo3` to 0.28.0 ([27a7d93](27a7d93aaefc3e7b649c772244c95ab209d859da)), closes #591, closes #593
- Update `rand` to 0.10.0 ([c077f00](c077f004ccbb1e6dc6429e75e31b21e4ae94dd94)), closes #592, closes #594
- Convert `allow` to `expect` for lints ([#596](https://github.com/chrjabs/rustsat/pull/596)) ([69b046d](69b046d090c4c51407278848a9f3de2926c6ed3c))
- Update and cleanup dependencies ([#619](https://github.com/chrjabs/rustsat/pull/619)) ([f7798bd](f7798bde002633cece47a50f3fb450b5adaa365d))
- Clippy fixes ([deed323](deed32353a9e2f85ddc4eae05fa786c13aff2928))
- Setup pre-push hooks ([021df8e](021df8e13253671991ca30db2dee9a1444721692))
- Rename directories containing vendored code ([dce5d83](dce5d831d2826724d6f2d1659097f86728f433ea))
- Update dev env and dev rust version ([#713](https://github.com/chrjabs/rustsat/pull/713)) ([1fb7fbe](1fb7fbebfc81927d9b46bcd3dc6002051bbff916))
- Some cleanup ([#722](https://github.com/chrjabs/rustsat/pull/722)) ([e921a10](e921a103da88da5726b5fc2e92bb1297b774c201))
- Use fewer and individual `use` statements ([4b63725](4b637252834f3beb1f9b761d7b2806cf7e801864))
- Remove some inline modules ([949fe3b](949fe3bc1eb3f440dcee5f6b024c7045ce733809))
- Loosen dependency strictness ([55dbd3e](55dbd3e9e93a6d5fc3c1f2afdb41dc2255db3330))
- Update lockfile ([dcb61bc](dcb61bc83b5faedae489d3d4254a1da72d2aff1d))

<!-- generated by git-cliff -->

## rustsat-v0.7.5 - 2026-01-30

[1188126](1188126e06716b082859aa169d5e985cc75b37a6)...[603d72a](603d72ae169bebcb24901307600b93cb06174b84)

**NOTE**: this will be the last release before some major API changes that will arrive in v0.8.0.
Progress on the work related to the API changes is tracked [here](https://github.com/chrjabs/rustsat/milestone/5).
...
- 2-product am1 encoding (#539) ([ed5ac2c](ed5ac2cbb3025965681f336f0b36c1df4c7d282e))

### <!-- 1 -->Bug Fixes

- Properly handle offsets in totdb ([bc281b8](bc281b8efb096621a4cd51390aa919ca8966de76))
- Merging two unweighted trees with same unit weight ([e932e98](e932e987a1d2b912683a6667bc1698c6dc543b7e))
- Proper state handling ([10188ed](10188edfc85f3681f1caf4d8fad371c388b35e52))
- Typos ([422db78](422db78de54f661645ad73fb59d39ffc5b4c323a))
- Don't assert but return `None` (#548) ([27f9eea](27f9eea9d3e942b000c4a1a1ae46a8219f97e002))
