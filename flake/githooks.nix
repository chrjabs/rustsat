      ...
      pre-commit.settings = {
        ...
        hooks =
          ...
          in
          {
            ...
            codegen = {
              enable = true;
              entry = "${lib.getExe' self'.packages.rust-toolchain "cargo"} run -p rustsat-codegen -- --check";
              files = "^codegen/";
              pass_filenames = false;
              priority = 10;
            };
            ...
            clippy = {
              ...
              packageOverrides = {
                ...
                clippy = self'.packages.rust-toolchain;
              };
              settings = {
                denyWarnings = true;
            ...
            tests = {
              ...
              pass_filenames = false;
              entry = ''
                ${lib.getExe' self'.packages.rust-toolchain "cargo"} nextest run \
                  --profile git-hook \
