...
/// Variables can be printed with the [`std::fmt::Display`] trait
...
/// Variables can be printed with the [`std::fmt::Debug`] trait
...
/// Literals can be printed with the [`std::fmt::Display`] trait
...
/// Literals can be printed with the [`std::fmt::Debug`] trait
...
/// Ternary values can be printed with the [`std::fmt::Display`] trait
...
/// Ternary values can be printed with the [`std::fmt::Debug`] trait
