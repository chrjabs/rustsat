...
impl Solver {
    ...
    ///
    /// ```
    /// let solver = rustsat::solvers::ExternalSolver::new(
    ///     std::process::Command::new("<path to solver binary>"),
    ///     rustsat::solvers::external::InputVia::tempfile_last(),
    ///     rustsat::solvers::external::OutputVia::pipe(),
    ///     "solver-signature",
    /// );
    /// ```
    ...
    ///
    /// ```
    /// let solver = rustsat::solvers::ExternalSolver::new_default(
    ///     std::process::Command::new("<path to solver binary>"),
    ///     "solver-signature",
    /// );
    /// ```
