...
mod test {
    ...
    #[test]
    fn build_destroy() {
        let _solver = MinisatSimp::default();
    }

    #[test]
    fn build_two() {
        let _solver1 = MinisatSimp::default();
        let _solver2 = MinisatSimp::default();
    }

    #[test]
    fn tiny_instance_sat() {
        let mut solver = MinisatSimp::default();
