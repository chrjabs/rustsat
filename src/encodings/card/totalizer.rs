...
use super::{Encode, EncodingError, EncodeIncremental, BoundLowerIncremental, BoundUpperIncremental, BoundLower, BoundUpper};
use crate::{
...
mod tests {
    ...
    use crate::{
        encodings::{
            card::{BoundBoth, BoundLowerIncremental, BoundUpperIncremental, BoundLower, BoundUpper},
