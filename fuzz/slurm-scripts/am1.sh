#!/bin/bash -l
#SBATCH -J rustsat-fuzz:am1
#SBATCH -o /wrk-kappa/users/chrisjab/rustsat-fuzz/slurm/am1_%a.out
#SBATCH -e /wrk-kappa/users/chrisjab/rustsat-fuzz/slurm/am1_%a.err
#SBATCH -t 600
#SBATCH -M kale
#SBATCH -p short
