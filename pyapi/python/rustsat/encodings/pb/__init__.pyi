...
class GeneralizedTotalizer:
    def __new__(cls, lits: List[tuple[int, Lit]] = []) -> "GeneralizedTotalizer": ...
...
class DynamicPolyWatchdog:
    def __new__(cls, lits: List[tuple[int, Lit]] = []) -> "DynamicPolyWatchdog": ...
    def weight_sum(self) -> int: ...
    def n_clauses(self) -> int: ...
    def n_vars(self) -> int: ...
    def encode_ub(self, min_ub: int, max_ub: int, var_manager: VarManager) -> Cnf: ...
...
@final
class BinaryAdder:
    def __new__(cls, lits: List[tuple[int, Lit]] = []) -> "BinaryAdder": ...
    def extend(self, lits: List[Lit]) -> None: ...
    def weight_sum(self) -> int: ...
    def n_clauses(self) -> int: ...
    def n_vars(self) -> int: ...
