...
#[derive(Debug)]
pub struct Glucose {
    handle: *mut crate::ffi::CGlucose4,
...
impl Default for Glucose {
    fn default() -> Self {
        let handle = unsafe { crate::ffi::cglucose4_init() };
        assert!(
            !handle.is_null(),
...
impl Glucose {
    ...
    #[inline]
    fn update_avg_clause_len(&mut self, clause: &rustsat::types::Cl) {
    ...
    pub fn set_limit(&mut self, limit: crate::Limit) {
        match limit {
            crate::Limit::None => unsafe { crate::ffi::cglucose4_set_no_limit(self.handle) },
            crate::Limit::Conflicts(limit) => unsafe {
                crate::ffi::cglucose4_set_conf_limit(self.handle, limit);
            },
            crate::Limit::Propagations(limit) => unsafe {
                crate::ffi::cglucose4_set_prop_limit(self.handle, limit);
            },
        }
    }
    ...
    pub fn n_assigns(&self) -> c_int {
        unsafe { crate::ffi::cglucose4_n_assigns(self.handle) }
    }

    /// Gets the current number of learnt clauses
    #[must_use]
    pub fn n_learnts(&self) -> c_int {
        unsafe { crate::ffi::cglucose4_n_learnts(self.handle) }
    }
}
...
impl rustsat::solvers::Solve for Glucose {
    ...
    fn solve(&mut self) -> anyhow::Result<SolverResult> {
        ...
        let res = crate::handle_oom!(unsafe {
            crate::ffi::cglucose4_solve(self.handle, std::ptr::null(), 0)
        });
    ...
    fn lit_val(&self, lit: Lit) -> anyhow::Result<rustsat::types::TernaryVal> {
        ...
        match unsafe { crate::ffi::cglucose4_val(self.handle, lit.into()) } {
        ...
        C: AsRef<Cl> + ?Sized,
    {
        ...
        crate::handle_oom!(unsafe {
            crate::ffi::cglucose4_add_clause(
                self.handle,
    ...
    fn reserve(&mut self, max_var: Var) -> anyhow::Result<()> {
        crate::handle_oom!(unsafe {
            ...
            crate::ffi::cglucose4_reserve(self.handle, max_var.idx32() as c_int)
        });
        Ok(())
    }
}
...
impl rustsat::solvers::SolveIncremental for Glucose {
    fn solve_assumps(&mut self, assumps: &[Lit]) -> anyhow::Result<SolverResult> {
        ...
        // Solve with glucose backend
        let res = crate::handle_oom!(unsafe {
            crate::ffi::cglucose4_solve(self.handle, assumps.as_ptr().cast(), assumps.len())
        });
        self.stats.cpu_solve_time += start.elapsed();
        match res {
            0 => {
...
impl rustsat::solvers::InterruptSolver for Interrupter {
    fn interrupt(&self) {
        unsafe { crate::ffi::cglucose4_interrupt(self.handle) }
    }
}
...
impl rustsat::solvers::PhaseLit for Glucose {
    ...
    fn phase_lit(&mut self, lit: Lit) -> anyhow::Result<()> {
        ...
        crate::handle_oom!(unsafe { crate::ffi::cglucose4_phase(self.handle, lit.into()) });
        Ok(())
    }
    ...
    fn unphase_var(&mut self, var: Var) -> anyhow::Result<()> {
        ...
        unsafe {
            #[expect(clippy::cast_possible_wrap)]
            crate::ffi::cglucose4_unphase(self.handle, var.idx32() as c_int);
        };
        Ok(())
    }
}
...
impl rustsat::solvers::GetInternalStats for Glucose {
    fn propagations(&self) -> usize {
        unsafe { crate::ffi::cglucose4_propagations(self.handle) }
            .try_into()
            .unwrap()
    }

    fn decisions(&self) -> usize {
        unsafe { crate::ffi::cglucose4_decisions(self.handle) }
            .try_into()
            .unwrap()
    }

    fn conflicts(&self) -> usize {
        unsafe { crate::ffi::cglucose4_conflicts(self.handle) }
            .try_into()
            .unwrap()
    }
}
...
impl rustsat::solvers::SolveStats for Glucose {
    ...
    fn max_var(&self) -> Option<Var> {
        let max_var_idx = unsafe { crate::ffi::cglucose4_n_vars(self.handle) };
        if max_var_idx > 0 {
            Some(Var::new(
                (max_var_idx - 1)
                    .try_into()
    ...
    fn n_clauses(&self) -> usize {
        unsafe { crate::ffi::cglucose4_n_clauses(self.handle) }
            .try_into()
            .unwrap()
    }
}
...
impl Drop for Glucose {
    fn drop(&mut self) {
        unsafe { crate::ffi::cglucose4_release(self.handle) }
    }
}
